...
coop:
	g++ -std=c++17 -O2 src/mainCoop.cpp src/IndexToPair.cpp src/Environment.cpp src/BoxPicker.cpp src/UpdateTargets.cpp  src/SimulateCoop.cpp src/CoopAstar.cpp -o coop
